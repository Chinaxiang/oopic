...
$(document).ready(function () {
    ...
    var scripts = {};
    scripts['SMMS'] = "upUrl = 'https://sm.ms/api/v2/upload';\n"
        ...
        + "    return image_url;\n"
        + "}";
    scripts['图壳'] = "// 修改为您的图壳本地代理，教程：https://mp.weixin.qq.com/s/BB41sswbMrQfreitQPDzjA\n"
        + "upUrl = 'http://localhost:8080/api/v2/files/upload';\n"
        + "function buildForm(file) {\n"
        + "    var data = new FormData();\n"
    ...
    scripts['阿里云OSS'] = "upUrl = 'https://your-bucket-url';\n"
        ...
        + "function parseRet(text, formData) {\n"
        + "    return 'https://your-bucket-url/' + formData.get('key');\n"
        + "}\n"
        + "function buildForm(file) {\n"
        + "    var policyText = {\n"
        ...
        + "    return data;\n"
        + "}";
    scripts['七牛云OSS'] = "upUrl = 'https://your-upload-url';\n"
        + "var accessKey = 'your ak';\n"
        + "var secretKey = 'your sk';\n"
